...
export class Socket extends EventEmitter {
	...
	send(buffer: Buffer, offset: number, length: number, address: any, beforeCallback: Function, afterCallback: Function): Socket;
...
export function writeChecksum(buffer: Buffer, offset: number, checksum: any): Buffer;
